...
{
    path_abs = ros::package::getPath("sk_navigation") + path_local;
...
int main(int argc, char** argv)
{
    ...
    ros::Publisher pubWaypointNodeEnded = n.advertise<std_msgs::Bool>("/sk_navigation/waypoint_following_status", 100);
    ...
    ros::param::get("/sk_navigation/coordinates_file", path_local);
